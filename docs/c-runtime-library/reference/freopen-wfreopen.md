...
Die **freopen** -Funktion schließt die Datei, die derzeit mit *Stream* verknüpft ist, und weist den *Stream* der durch *path*angegebenen Datei neu zu. **_wfreopen** ist eine breit Zeichen Version von **_freopen**. die *Pfad* - *und* Modusargumente für **_wfreopen** sind Zeichen folgen mit breit Zeichen. **_wfreopen** und **_freopen** Verhalten sich andernfalls identisch.
