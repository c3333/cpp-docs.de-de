...
**_ismbbpunct** gibt einen Wert ungleich Null zurück, wenn die ganze Zahl *c* ein Nicht-ASCII-Satzzeichen ist. **_ismbbpunct** verwendet das aktuelle Gebietsschema für alle gebietsschemaabhängigen Zeicheneinstellungen. **_ismbbpunct_l** identisch ist, außer dass es das Gebietsschema verwendet, das übergeben wurde. Weitere Informationen finden Sie unter [Locale](../../c-runtime-library/locale.md).
