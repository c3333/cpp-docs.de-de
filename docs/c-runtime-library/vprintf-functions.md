...
Bei **vsprintf** `_vsnprintf` , `_vsnwprintf` `vswprintf`und , wenn das Kopieren zwischen Überlappungen zwischen Zeichenfolgen auftritt, ist das Verhalten nicht definiert.
