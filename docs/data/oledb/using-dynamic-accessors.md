...
## <a name="example-cdynamic-accessors"></a>Beispiel: cdynamic-Accessoren
...
## <a name="example-cdynamicstringaccessor"></a>Beispiel: CDynamicStringAccessor
