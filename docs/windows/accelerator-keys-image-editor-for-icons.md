...
|Image.NewImageType|**Einfügen**|Öffnet das [ \<Device> Dialogfeld Neuer Bildtyp](./creating-an-icon-or-other-image-image-editor-for-icons.md) , in dem Sie ein Bild für einen anderen Bildtyp erstellen können.|
