...
|[Zollunion](custom-cpp.md)|Ermöglicht Ihnen, eigene Attribute zu definieren.|
...
|[implementiert](implements-cpp.md)|Gibt Dispatch-Schnittstellen an, die als Member der IDL-Co-Klasse erzwungen werden.|
...
|[satype](satype.md)|Gibt den Datentyp von an `SAFEARRAY` .|
...
|[synchronisiert](synchronize.md)|Synchronisiert den Zugriff auf eine Methode.|
