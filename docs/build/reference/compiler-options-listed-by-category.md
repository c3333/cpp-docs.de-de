...
|[/Guard: ehact](guard-enable-eh-continuation-metadata.md)|Aktiviert die eh-Fortsetzungs Metadaten.|
...
|[/Yc](yc-create-precompiled-header-file.md)|*`.PCH`* Datei erstellen.|
