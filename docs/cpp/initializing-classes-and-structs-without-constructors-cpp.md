...
description: Verwenden der geschweifter Klammer Initialisierung mit einer beliebigen C++-Klasse, Struktur oder Union
ms.date: 11/19/2019
...
> [!IMPORTANT]
> Um diese Klasse verwenden zu können, müssen Sie den- [\<initializer_list>](../standard-library/initializer-list.md) Header einschließen.
