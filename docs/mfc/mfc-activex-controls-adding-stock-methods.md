...
Das Hinzufügen einer Aktien Methode ist einfach mithilfe des [Assistenten zum Hinzufügen von Methoden](../ide/adding-a-method-visual-cpp.md#add-method-wizard). Das folgende Verfahren veranschaulicht das Hinzufügen der Aktualisierungs Methode zu einem Steuerelement, das mit dem MFC-ActiveX-Steuerelement-Assistenten
