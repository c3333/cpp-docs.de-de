...
- [Ergänzungen zu Ihrem Kontrollprojekt](#_core_additions_to_your_control_project)
...
## <a name="implementing-a-custom-picture-property-in-your-activex-control"></a><a name="_core_implementing_a_custom_picture_property_in_your_activex_control"></a>Implementieren einer benutzerdefinierten Bildeigenschaft in Ihrem ActiveX-Steuerelement
...
Um die Eigenschaftenseiten-ID für die Standardmäßige Picture-Eigenschaftsseite hinzuzufügen, fügen Sie die folgende Zeile nach dem BEGIN_PROPPAGEIDS-Makro in die Steuerelementimplementierungsdatei ein (. CPP):
...
Es ist nicht notwendig, Ihr Datenmitglied *m_pic*zu nennen; jeder Name genügt.
...
1. Wählen Sie im Feld **Eigenschaftentyp** **IPictureDisp** <strong>\*</strong> für den Eigenschaftstyp aus.
