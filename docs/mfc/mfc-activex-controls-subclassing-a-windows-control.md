...
Um und zu überschreiben `PreCreateWindow` `IsSubclassedControl` , fügen Sie dem- **`protected`** Abschnitt der Deklaration der Steuerelement Klasse die folgenden Codezeilen hinzu:
