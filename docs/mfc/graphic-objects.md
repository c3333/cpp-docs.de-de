...
Jede Grafikobjektklasse in der Klassenbibliothek verfügt über einen „cast“-Operator, der ein MFC-Objekt zum zugehörigen Windows-Handle umwandelt. Das resultierende Handle ist gültig, bis das zugeordnete Objekt es trennt. Verwenden Sie die Member-Funktion des-Objekts `Detach` , um das Handle zu trennen.
...
1. Definieren Sie ein Grafikobjekt im Stapelrahmen. Initialisieren Sie das Objekt mit der „type“-spezifischen „create“-Funktion wie `CreatePen`. Initialisieren Sie alternativ das Objekt im Konstruktor. Sehen Sie sich die Erörterung der [einstufigen und zweistufigen Erstellung](one-stage-and-two-stage-construction-of-objects.md)an, die Beispielcode enthält.

1. [Wählen Sie das Objekt im aktuellen Gerätekontext](selecting-a-graphic-object-into-a-device-context.md)aus, und speichern Sie das alte Grafik Objekt, das zuvor ausgewählt wurde.
...
- [Ein- und zweistufige Konstruktion von Grafikobjekten](one-stage-and-two-stage-construction-of-objects.md)

- [Beispiel für das Erstellen eines Stifts in einer oder zwei Phasen](one-stage-and-two-stage-construction-of-objects.md)
