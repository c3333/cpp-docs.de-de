...
|[CTreeCtrl:: kreateex](#createex)|Erstellt ein Struktur Steuerelement mit den angegebenen erweiterten Windows-Stilen und fügt es an ein- `CTreeCtrl` Objekt an.|
|[CTreeCtrl::D eleteallitems](#deleteallitems)|Löscht alle Elemente in einem Strukturansicht-Steuerelement.|
|[CTreeCtrl::D eleteitem](#deleteitem)|Löscht ein neues Element in einem Strukturansicht-Steuerelement.|
|[CTreeCtrl:: EditLabel](#editlabel)|Bearbeitet ein angegebenes Struktur Ansichts Element direkt.|
|[CTreeCtrl:: eindeditlabelnow](#endeditlabelnow)|Bricht den Bearbeitungsvorgang für die Bezeichnung eines Struktur Ansichts Elements im aktuellen Strukturansicht-Steuerelement ab.|
...
|[CTreeCtrl:: getitemexpandedimagein DEX](#getitemexpandedimageindex)|Ruft den Index des Bilds ab, das angezeigt werden soll, wenn sich das angegebene Element des aktuellen Strukturansicht-Steuer Elements im erweiterten Zustand befindet.|
...
|[CTreeCtrl:: getitempartrect](#getitempartrect)|Ruft das umgebende Rechteck für einen angegebenen Teil eines angegebenen Elements im aktuellen Strukturansicht-Steuerelement ab.|
...
|[CTreeCtrl:: getparameentitem](#getparentitem)|Ruft das übergeordnete Element des angegebenen Struktur Ansichts Elements ab.|
...
|[CTreeCtrl:: HitTest](#hittest)|Gibt die aktuelle Position des Cursors zurück, der mit dem-Objekt verknüpft ist `CTreeCtrl` .|
...
|[CTreeCtrl:: mapitemdeaccid](#mapitemtoaccid)|Ordnet das angegebene Handle einem Struktur Ansichts Element im aktuellen Strukturansicht-Steuerelement zu einem Barrierefreiheits Bezeichner zu.|
...
|[CTreeCtrl:: abtautoscrollinfo](#setautoscrollinfo)|Legt die automatische Scrollrate des aktuellen Strukturansicht-Steuer Elements fest.|
...
|[CTreeCtrl:: abtextendedstyle](#setextendedstyle)|Legt die erweiterten Stile für das aktuelle Strukturansicht-Steuerelement fest.|
...
|[CTreeCtrl:: abdent](#setindent)|Legt den Offset (in Pixel) eines Struktur Ansichts Elements aus dem übergeordneten Element fest.|
|[CTreeCtrl:: "Einfügemarke"](#setinsertmark)|Legt die Einfügemarke in einem Strukturansicht-Steuerelement fest.|
|[CTreeCtrl:: Settings-Datei](#setinsertmarkcolor)|Legt die Farbe fest, die zum Zeichnen der Einfügemarke für die Strukturansicht verwendet wird.|
|[CTreeCtrl:: System Item](#setitem)|Legt die Attribute eines angegebenen Struktur Ansichts Elements fest.|
|[CTreeCtrl:: abtitemdata](#setitemdata)|Legt den anwendungsspezifischen Wert fest, der einem Element zugeordnet ist.|
|[CTreeCtrl:: "ctretemexpandedimageindex"](#setitemexpandedimageindex)|Legt den Index des Bilds fest, das angezeigt wird, wenn sich das angegebene Element des aktuellen Strukturansicht-Steuer Elements im erweiterten Zustand befindet.|
|[CTreeCtrl:: "abtitemheight"](#setitemheight)|Legt die Höhe der Struktur Ansichts Elemente fest.|
|[CTreeCtrl:: "ctretemimage"](#setitemimage)|Ordnet Bilder einem Element zu.|
|[CTreeCtrl:: abtitemstate](#setitemstate)|Legt den Zustand eines Elements fest.|
|[CTreeCtrl:: "abtitemstateex"](#setitemstateex)|Legt den erweiterten Zustand des angegebenen Elements im aktuellen Strukturansicht-Steuerelement fest.|
|[CTreeCtrl:: abtitemtext](#setitemtext)|Legt den Text eines Elements fest.|
...
|[CTreeCtrl:: SortChildren-CB](#sortchildrencb)|Sortiert die untergeordneten Elemente eines angegebenen übergeordneten Elements mithilfe einer Anwendungs definierten Sortierfunktion.|
...
Weitere Informationen zum Verwenden von `CTreeCtrl` finden Sie unter:
...
*Rect*<br/>
Gibt die Größe und Position des Strukturansicht-Steuer Elements an. Dabei kann es sich entweder um ein [CRect](../../atl-mfc-shared/reference/crect-class.md) -Objekt oder um eine [Rect](/windows/win32/api/windef/ns-windef-rect) -Struktur handeln.

*pparser*<br/>
Gibt das übergeordnete Fenster des Strukturansicht-Steuer Elements an, in der Regel ein `CDialog` . Er darf nicht NULL sein.
...
Wenn Sie das Struktur Steuerelement als untergeordnetes Fenster eines anderen Fensters erstellen möchten, verwenden Sie die- `Create` Member-Funktion. Wenn Sie das Struktur Steuerelement mithilfe `Create` von erstellen, müssen Sie es zusätzlich zu anderen Struktur Ansichts Stilen an WS_VISIBLE übergeben.

Sie erstellen einen `CTreeCtrl` in zwei Schritten. Nennen Sie zuerst den-Konstruktor, `Create` und klicken Sie dann auf. Dadurch wird das Strukturansicht-Steuerelement erstellt und an das- `CTreeCtrl` Objekt angehängt.

Um ein Struktur Steuerelement mit erweiterten Fenster Stilen zu erstellen [, rufen Sie](#createex) anstelle von die Zeichenfolge "" auf `Create` .

### <a name="example"></a>Beispiel

[!code-cpp[NVC_MFC_CTreeCtrl#1](../../mfc/reference/codesnippet/cpp/ctreectrl-class_1.cpp)]

## <a name="ctreectrlcreateex"></a><a name="createex"></a> CTreeCtrl:: kreateex
...
## <a name="ctreectrlcreatedragimage"></a><a name="createdragimage"></a> CTreeCtrl:: kreatedragimage

Mit dieser Funktion können Sie eine Zieh Bitmap für das angegebene Element in einem Strukturansicht-Steuerelement erstellen, eine Bildliste für die Bitmap erstellen und der Bildliste das Bitmap hinzufügen.
...
## <a name="ctreectrlendeditlabelnow"></a><a name="endeditlabelnow"></a> CTreeCtrl:: eindeditlabelnow
...
*"f"*\
in TRUE, wenn Änderungen am Struktur Ansichts Element vor dem Abschluss des Bearbeitungsvorgangs verworfen werden sollen, oder false, um die Änderungen am Struktur Ansichts Element vor dem Abschluss des Vorgangs zu speichern.
...
Ein COLORREF-Wert, der die aktuelle Fenster Hintergrundfarbe für das-Steuerelement darstellt. Wenn dieser Wert-1 ist, verwendet das Steuerelement die System Fenster Farbe. In diesem Fall können Sie verwenden, `::GetSysColor(COLOR_WINDOW)` um die aktuelle System Farbe, die das Steuerelement verwendet, zu erhalten.
...
## <a name="ctreectrlgetitemexpandedimageindex"></a><a name="getitemexpandedimageindex"></a> CTreeCtrl:: getitemexpandedimagein DEX
...
*Hitem*\
in Handle für ein Steuerelement der Strukturansicht.
...
Diese Methode sendet die [TVM_GETITEM](/windows/win32/Controls/tvm-getitem) Nachricht, die in der Windows SDK beschrieben wird. Diese Meldung gibt die [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur zurück, die das Steuerelement der Strukturansicht beschreibt, und dann ruft diese Methode den `iExpandedImage` Member aus dieser Struktur ab.
...
*npart*\
in Der Bezeichner für den Teil. Muss auf TVGIPR_BUTTON festgelegt werden.

*lprect*\
vorgenommen Zeiger auf eine [Rect](/windows/win32/api/windef/ns-windef-rect) -Struktur. Wenn diese Methode erfolgreich ist, empfängt die-Struktur die Rechteck Koordinaten des von *Hitem* und *npart*angegebenen Teils.
...
Im folgenden Codebeispiel wird die-Variable definiert, die `m_treeCtrl` für den Zugriff auf das aktuelle Strukturansicht-Steuerelement verwendet wird. Das Codebeispiel definiert auch eine Ganzzahl ohne Vorzeichen und mehrere HTREEITEM-Variablen. Diese Variablen werden im nächsten Beispiel verwendet.
...
*lprect*<br/>
Ein Zeiger auf eine [Rect](/windows/win32/api/windef/ns-windef-rect) -Struktur, die das umschließende Rechteck empfängt. Die Koordinaten sind relativ zur linken oberen Ecke des Strukturansicht-Steuer Elements.
...
*nStatus-Frage*<br/>
Maske, die einen oder mehrere Zustände angibt, die abgerufen werden sollen. Weitere Informationen zu möglichen Werten für *nStatus*finden Sie in der Erörterung der Elemente `state` und `stateMask` der [tvitem](/windows/win32/api/commctrl/ns-commctrl-tvitemw) -Struktur in der Windows SDK.
...
Der erweiterte Zustand des Elements. Weitere Informationen finden Sie unter dem- `uStateEx` Member der [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur.
...
Diese Funktion gibt NULL zurück, wenn das abgerufene Element der Stamm Knoten der Struktur ist. Wenn Sie diese Meldung z. b. mit dem TVGN_PARENT-Flag auf einem untergeordneten Element der Strukturansicht des Stamm Knotens der Strukturansicht verwenden, gibt die Meldung NULL zurück.
...
## <a name="ctreectrlgetparentitem"></a><a name="getparentitem"></a> CTreeCtrl:: getparameentitem
...
*pflags*<br/>
Ein Zeiger auf eine ganze Zahl, die Informationen zu den Ergebnissen des Treffer Tests empfängt. Dabei kann es sich um einen oder mehrere der Werte handeln, die unter dem- `flags` Member im Abschnitt "Hinweise" aufgeführt sind.
...
*lpinsertstruct*<br/>
Ein Zeiger auf einen `TVINSERTSTRUCT` , der die Attribute des einzufügenden Struktur Ansichts Elements angibt.

*nmask*<br/>
Eine ganze Zahl, die die festzulegenden Attribute angibt. Weitere Informationen finden Sie `TVITEM` in der Struktur des Windows SDK.
...
*nStatus-Frage*<br/>
Gibt an, welche Zustände festgelegt werden sollen. Weitere Informationen finden Sie `TVITEM` in der Struktur des Windows SDK.
...
*uaccid*\
in Ein Barrierefreiheits Bezeichner für ein Element im Struktur Ansichts Element.
...
## <a name="ctreectrlmapitemtoaccid"></a><a name="mapitemtoaccid"></a> CTreeCtrl:: mapitemdeaccid
...
*Hitem*\
in Ein Handle eines Struktur Ansichts Elements im-Steuerelement. Weitere Informationen finden Sie unter dem *Hitem* -Member der [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur.
...
Mit dieser Funktion können Sie das angegebene Struktur Ansichts Element auswählen, einen Bildlauf für das Element durchführen oder das Element im Stil neu zeichnen, um das Ziel eines Drag & Drop-Vorgangs anzugeben.
...
## <a name="ctreectrlsetautoscrollinfo"></a><a name="setautoscrollinfo"></a> CTreeCtrl:: abtautoscrollinfo
...
*upixelspersec*\
in Die Anzahl der Pixel pro Sekunde für den Bildlauf.

*uupdatetime*\
in Das Zeitintervall zwischen Updates des-Steuer Elements.
...
*Besuchen*<br/>
Gibt an, ob das Struktur Steuerelement aktiviert oder deaktiviert werden soll. Standardmäßig wird `SetCheck` das zu überprüfende Element festgelegt.
...
## <a name="ctreectrlsetextendedstyle"></a><a name="setextendedstyle"></a> CTreeCtrl:: abtextendedstyle
...
## <a name="ctreectrlsetindent"></a><a name="setindent"></a> CTreeCtrl:: abdent
...
## <a name="ctreectrlsetinsertmark"></a><a name="setinsertmark"></a> CTreeCtrl:: "Einfügemarke"
...
## <a name="ctreectrlsetinsertmarkcolor"></a><a name="setinsertmarkcolor"></a> CTreeCtrl:: Settings-Datei
...
## <a name="ctreectrlsetitem"></a><a name="setitem"></a> CTreeCtrl:: System Item
...
*Hitem*<br/>
Handle des Elements, dessen Attribute festgelegt werden sollen. Siehe den- `hItem` Member der- `TVITEM` Struktur in der Windows SDK.
...
In der- `TVITEM` Struktur `hItem` identifiziert das-Element das Element, und der- `mask` Member gibt an, welche Attribute festgelegt werden sollen.

Wenn das Element `mask` oder der *nmask* -Parameter den TVIF_TEXT Wert angibt, `pszText` ist der Member oder das *lpszitem* die Adresse einer auf NULL endenden Zeichenfolge, und der `cchTextMax` Member wird ignoriert. Wenn `mask` (oder *nmask*) den TVIF_STATE Wert angibt, `stateMask` gibt der Member oder der *nStateMask* -Parameter an, welche Element Zustände geändert werden sollen, und der `state` Member-oder *nState* -Parameter enthält die Werte für diese Zustände.

### <a name="example"></a>Beispiel

[!code-cpp[NVC_MFC_CTreeCtrl#32](../../mfc/reference/codesnippet/cpp/ctreectrl-class_38.cpp)]

## <a name="ctreectrlsetitemdata"></a><a name="setitemdata"></a> CTreeCtrl:: abtitemdata
...
## <a name="ctreectrlsetitemexpandedimageindex"></a><a name="setitemexpandedimageindex"></a> CTreeCtrl:: "ctretemexpandedimageindex"

Legt den Index des Bilds fest, das angezeigt wird, wenn sich das angegebene Element des aktuellen Strukturansicht-Steuer Elements im erweiterten Zustand befindet.
...
## <a name="ctreectrlsetitemheight"></a><a name="setitemheight"></a> CTreeCtrl:: "abtitemheight"
...
## <a name="ctreectrlsetitemimage"></a><a name="setitemimage"></a> CTreeCtrl:: "ctretemimage"
...
## <a name="ctreectrlsetitemstate"></a><a name="setitemstate"></a> CTreeCtrl:: abtitemstate
...
## <a name="ctreectrlsetitemstateex"></a><a name="setitemstateex"></a> CTreeCtrl:: "abtitemstateex"
...
*ustateex*\
in Der erweiterte Zustand des Elements. Weitere Informationen finden Sie unter dem- `uStateEx` Member der [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur.
...
Diese Methode sendet die [TVM_SETITEM](/windows/win32/Controls/tvm-setitem) Nachricht, die in der Windows SDK beschrieben wird. Diese Methode weist den *ustateex* -Parameter dem `uStateEx` -Member einer [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur zu und verwendet dann diese Struktur in der Nachricht.
...
Im folgenden Codebeispiel wird ein Struktur Ansichts Element auf den deaktivierten Zustand festgelegt. In einem früheren Abschnitt des Code Beispiels, der nicht gezeigt wird, haben wir eine Strukturansicht erstellt, die aus einem Stamm Knoten Land/Region für die USA, untergeordneten Knoten für die Zustände von Pennsylvania und Washington und Strukturelemente für Städte in diesen Bundesstaaten besteht. In diesem Codebeispiel wird der Knoten Pennsylvania auf deaktiviert festgelegt.

[!code-cpp[NVC_MFC_CTreeCtrl_s1#7](../../mfc/reference/codesnippet/cpp/ctreectrl-class_41.cpp)]

## <a name="ctreectrlsetitemtext"></a><a name="setitemtext"></a> CTreeCtrl:: abtitemtext

Legt den Text des durch *Hitem*angegebenen Elements fest.
...
*lpszitem*<br/>
Die Adresse einer Zeichenfolge, die den neuen Text für das Element enthält.
...
Mit dieser Member-Funktion können Sie die aktuelle Linien Farbe für das Strukturansicht-Steuerelement festlegen.
...
*clrnew*<br/>
Die neue Linien Farbe.

### <a name="return-value"></a>Rückgabewert

Die vorherige Linien Farbe.

### <a name="remarks"></a>Bemerkungen

Diese Member-Funktion implementiert das Verhalten der Win32-Nachricht [TVM_SETLINECOLOR](/windows/win32/Controls/tvm-setlinecolor), wie in der Windows SDK beschrieben.
...
Mit dieser Member-Funktion können Sie die maximale Scrollzeit für das Strukturansicht-Steuerelement festlegen.
...
*"US-crolltime"*<br/>
Die neue maximale Scrollzeit in Millisekunden. Wenn dieser Wert kleiner als 100 ist, wird er auf 100 aufgerundet.

### <a name="return-value"></a>Rückgabewert

Die vorherige maximale Scrollzeit in Millisekunden.

### <a name="remarks"></a>Bemerkungen

Diese Member-Funktion implementiert das Verhalten der Win32-Nachricht [TVM_SETSCROLLTIME](/windows/win32/Controls/tvm-setscrolltime), wie in der Windows SDK beschrieben.

## <a name="ctreectrlsettextcolor"></a><a name="settextcolor"></a> CTreeCtrl:: SetTextColor

Diese Member-Funktion implementiert das Verhalten der Win32-Nachricht [TVM_SETTEXTCOLOR](/windows/win32/Controls/tvm-settextcolor), wie in der Windows SDK beschrieben.
...
*CLR*<br/>
Ein COLORREF-Wert, der die neue Textfarbe enthält. Wenn dieses Argument-1 ist, verwendet das Steuerelement die System Farbe für die Textfarbe.

### <a name="return-value"></a>Rückgabewert

Ein COLORREF-Wert, der die vorherige Textfarbe darstellt. Wenn dieser Wert-1 ist, verwendet das Steuerelement die System Farbe für die Textfarbe.
...
Diese Member-Funktion implementiert das Verhalten der Win32-Nachricht [TVM_SETTOOLTIPS](/windows/win32/Controls/tvm-settooltips), wie in der Windows SDK beschrieben.
...
*pwndtip*<br/>
Ein Zeiger auf ein [CToolTipCtrl](../../mfc/reference/ctooltipctrl-class.md) -Objekt, das vom Struktur Steuerelement verwendet wird.

### <a name="return-value"></a>Rückgabewert

Ein Zeiger auf ein [CToolTipCtrl](../../mfc/reference/ctooltipctrl-class.md) -Objekt, das die QuickInfo enthält, die zuvor vom Steuerelement verwendet wurde, oder NULL, wenn zuvor keine Quick Infos verwendet wurden.

### <a name="remarks"></a>Bemerkungen

Wenn Sie Quick Infos verwenden möchten, geben Sie den TVS_NOTOOLTIPS Stil an, wenn Sie das `CTreeCtrl` Objekt erstellen.

### <a name="example"></a>Beispiel

  Weitere Informationen finden Sie im Beispiel für [CTreeCtrl:: gettooltips](#gettooltips).

## <a name="ctreectrlshowinfotip"></a><a name="showinfotip"></a> CTreeCtrl:: ShowInfoTip

Zeigt den Infotipp für das angegebene Element im aktuellen Strukturansicht-Steuerelement an.
...
*Hitem*\
in Ein Handle für ein Struktur Ansichts Element im-Steuerelement. Weitere Informationen finden Sie unter dem- `hItem` Member der [tvitemex](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) -Struktur.

### <a name="remarks"></a>Bemerkungen

Weitere Informationen zu den Unterschieden zwischen Quick Infos und infotips finden Sie im [Microsoft Developer Network](https://go.microsoft.com/fwlink/p/?linkid=56322)im Thema "Quick Infos und infotips".

Diese Methode sendet die [TVM_SHOWINFOTIP](/windows/win32/Controls/tvm-showinfotip) Nachricht, die in der Windows SDK beschrieben wird.

## <a name="ctreectrlsortchildren"></a><a name="sortchildren"></a> CTreeCtrl:: SortChildren

Mit dieser Funktion können Sie die untergeordneten Elemente des angegebenen übergeordneten Elements in einem Strukturansicht-Steuerelement alphabetisch sortieren.
...
*Hitem*<br/>
Handle des übergeordneten Elements, dessen untergeordnete Elemente sortiert werden sollen. Wenn *Hitem* den Wert NULL hat, wird die Sortierung aus dem Stamm der Struktur fortgesetzt.
...
`SortChildren` wird nicht durch die Struktur rekursiert; nur die unmittelbar untergeordneten Elemente des *Hitem* werden sortiert.

### <a name="example"></a>Beispiel

[!code-cpp[NVC_MFC_CTreeCtrl#37](../../mfc/reference/codesnippet/cpp/ctreectrl-class_45.cpp)]

## <a name="ctreectrlsortchildrencb"></a><a name="sortchildrencb"></a> CTreeCtrl:: SortChildren-CB

Mit dieser Funktion können Sie Struktur Ansichts Elemente mithilfe einer Anwendungs definierten Rückruffunktion sortieren, mit der die Elemente verglichen werden.
...
*PSORT*<br/>
Zeiger auf eine [tvsortcb](/windows/win32/api/commctrl/ns-commctrl-tvsortcb) -Struktur.
...
Die Vergleichsfunktion der-Struktur `lpfnCompare` muss einen negativen Wert zurückgeben, wenn das erste Element dem zweiten vorangestellt wird, einen positiven Wert, wenn das erste Element der zweiten entspricht, oder 0 (null), wenn die beiden Elemente äquivalent sind.

Der *lParam1* -Parameter und der *lParam2* -Parameter entsprechen dem- `lParam` Member der [tvitem](/windows/win32/api/commctrl/ns-commctrl-tvitemw) -Struktur für die beiden zu vergleichenden Elemente. Der *lparamsort* -Parameter entspricht dem- `lParam` Member der- `TV_SORTCB` Struktur.
