...
*Kampagnen*<br/>
Ein Zeiger auf ein [addrinfot](/windows/win32/api/ws2def/ns-ws2def-addrinfoa) , das Socketinformationen wie die Familie und den Sockettyp enthalten soll.
