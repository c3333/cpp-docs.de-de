...
|`IsBOF`=0,<br /><br /> `IsEOF`= ungleich 0 (null)|Zulässig|Zulässig|Ausnahme|Ausnahme|
...
- `dbOpenDynaset` einen Dynaset-Type-Recordset mit bidirektionalem Bildlauf. Dies ist die Standardoption.
