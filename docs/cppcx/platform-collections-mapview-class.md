...
*Il*<br/>
Eine [Std:: initializer_list<Std::p Air \<K,V> > ](../standard-library/initializer-list-class.md) , deren Elemente in die MapView eingefügt werden.
