...
description: Links zu Inhalten über die C++/CLI-und C++/CX-Generika Features,-Typen und-Methoden.
ms.date: 09/25/2020
ms.topic: reference
f1_keywords:
- generic_cpp
...
ms.locfileid: "91414645"
---
# <a name="generics--ccli-and-ccx"></a>Generics (C++/CLI und C++/CX)

Generics sind parametrisierte Typen und Methoden. In diesem Abschnitt erfahren Sie, welche generischen Features sowohl die Windows-Runtime als auch die Common Language Runtime unterstützen und welche Funktionen nur vom Common Language Runtime unterstützt werden. Außerdem erfahren Sie, wie Sie Ihre eigenen generischen Methoden und Typen in C++/CLI erstellen, und wie Sie generische Typen verwenden, die in einer .NET Framework Sprache in C++ erstellt wurden/CLI. Abschließend bietet dieser Abschnitt einen Vergleich zwischen Generics und C++-Vorlagen.
...
Informationen zu den Generika, der Motivation für die Sprachfunktion und Definitionen von Begriffen, die zum Beschreiben von Generika verwendet werden. Außerdem Informationen zur Verwendung von Verweis Typen und Werttypen als Typparameter für Generika.
