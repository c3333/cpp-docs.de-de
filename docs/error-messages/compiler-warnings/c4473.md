...
ms.locfileid: "82825742"
---
# <a name="compiler-warning-level-1-c4473"></a>Compilerwarnung (Stufe 1) C4473

> "*Funktion*": nicht genügend Argumente für Format Zeichenfolge
> Platzhalter und deren Parameter erwarten *Zahl* Variadic-Argumente, aber es wurden *Zahl* angegeben.
> der fehlende Variadic-Argument *Index* ist für die Format Zeichenfolge '*FORMAT_STRING*' \ erforderlich.
...
In der ersten Fehlermeldung erkennt der Compiler, dass ein Argument fehlt, aber es kann nicht festgestellt werden, ob es sich bei dem fehlenden Argument um die Breite oder den Inhalt handelt. Daher geht es davon aus, dass das angegebene Argument das erste, für die Breite und das fehlende Argument das zweite für den typkonvertierungsspezifizierer ist. Sie müssen die Format Zeichenfolge überprüfen, um das tatsächliche fehlende Argument zu ermitteln.
