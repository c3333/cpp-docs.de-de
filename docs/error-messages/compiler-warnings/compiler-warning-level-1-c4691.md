...
Es kann jedoch ein unerwartetes Verhalten auftreten, wenn der Compiler eine Definition verwendet, die nicht aus derselben Assembly gehört, auf die in den Metadaten verwiesen wird. CLR-Typen werden nicht nur durch den Namen des Typs, sondern auch durch die Assembly typisiert.  Das heißt, ein Typ z aus Assembly z.dll unterscheidet sich von dem Typ z von der Assembly y.dll.
