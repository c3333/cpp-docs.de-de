...
ms.locfileid: "81371927"
---
# <a name="collate-class"></a>collate-Klasse

Eine Klassenvorlage, die ein Objekt beschreibt, das als Gebietsschema dienen kann, um die Reihenfolge und Gruppierung von Zeichen innerhalb einer Zeichenfolge, Vergleiche zwischen ihnen und das Hashing von Zeichenfolgen zu steuern.
...
|-|-|
|[Vergleichen](#compare)|Vergleicht zwei Zeichensequenzen nach ihren facetspezifischen Regeln für Gleichheit oder Ungleichheit.|
...
|[Verwandeln](#transform)|Konvertiert eine Zeichenfolge von einem Gebietsschema in eine Zeichenfolge, die in den lexikografischen Vergleichen mit anderen Zeichenfolgen verwendet wird, die auf ähnliche Weise aus dem gleichen Gebietsschema konvertiert wurden.|
...
## <a name="collatechar_type"></a><a name="char_type"></a>kollaten::char_type
...
## <a name="collatecompare"></a><a name="compare"></a>collate::vergleichen
...
Die Memberfunktion [do_compare](#do_compare)gibt `first1` `last1`do_compare `first2` `last2`zurück ( , , , ).
...
Die Memberfunktion gibt `first` `last` [do_hash](#do_hash)zurück ( , ).
...
## <a name="collatestring_type"></a><a name="string_type"></a>kollaten::string_type
...
Der Typ beschreibt eine Spezialisierung von [Klassenvorlagenbasic_string](../standard-library/basic-string-class.md) deren Objekte Kopien der Quellsequenz speichern können.
...
Die Memberfunktion gibt`first` `last` [do_transform](#do_transform)zurück ( , ).
