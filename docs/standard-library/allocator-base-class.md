...
*PPEN*\
Die Synchronisierungsrichtlinie für die Zuweisung: [sync_none-Klasse](sync-none-class.md), [sync_per_container-Klasse](sync-per-container-class.md), [sync_per_thread-Klasse](sync-per-thread-class.md) oder [sync_shared-Klasse](sync-shared-class.md).
