...
ms.locfileid: "87520589"
---
# <a name="unary_function-struct"></a>unary_function-Struktur
...
Die Vorlagen Struktur fungiert als Basis für Klassen, die eine Member-Funktion des Formulars definieren `result_type operator()( constargument_type& ) const` .
