...
|[CWindow::ScrollWindow](#scrollwindow)|Scrollt den angegebenen Clientbereich.|
...
[CWindowImpl](../../atl/reference/cwindowimpl-class.md) Ermöglicht es Ihnen, ein neues Fenster oder eine unterklassige ein vorhandenes Fenster zu erstellen.
...
Siehe [ChildWindowFromPoint](/windows/win32/api/winuser/nf-winuser-childwindowfrompoint) im Windows SDK.
...
Weitere Informationen finden Sie unter [EnableScrollBar](/windows/win32/api/winuser/nf-winuser-enablescrollbar) im Windows SDK.
...
Ruft das vorherige oder nächste Steuerelement mit dem WS_TABSTOP-Stil ab.
...
Ungültig macht den Clientbereich innerhalb der angegebenen Region ungültig.
...
Legt das Flag zum erneuten Zeichnen fest oder löscht es, indem eine [WM_SETREDRAW](/windows/win32/gdi/wm-setredraw) Nachricht an das Fenster gesendet wird.
...
*bZeichnung*<br/>
[in] Gibt den Status des Neuzeichnungsflags an. Wenn TRUE (der Standardwert), wird das Redraw-Flag gesetzt. wenn FALSE, wird das Flag gelöscht.

### <a name="remarks"></a>Bemerkungen

Aufruf, `SetRedraw` um das Erneutzeichnen von Änderungen zuzulassen oder zu verhindern, dass Änderungen neu gezeichnet werden.
...
Siehe [SetScrollInfo](/windows/win32/api/winuser/nf-winuser-setscrollinfo) im Windows SDK.
...
Siehe [SetScrollPos](/windows/win32/api/winuser/nf-winuser-setscrollpos) im Windows SDK.
...
Siehe [SetScrollRange](/windows/win32/api/winuser/nf-winuser-setscrollrange) im Windows SDK.
...
Siehe [SetTimer](/windows/win32/api/winuser/nf-winuser-settimer) im Windows SDK.
...
Siehe [SetWindowContextHelpId](/windows/win32/api/winuser/nf-winuser-setwindowcontexthelpid) im Windows SDK.
...
Siehe [SetWindowLong](/windows/win32/api/winuser/nf-winuser-setwindowlongw) im Windows SDK.

> [!NOTE]
> Um Code zu schreiben, der sowohl mit 32-Bit- als auch mit 64-Bit-Versionen von Windows kompatibel ist, verwenden Sie [CWindow::SetWindowLongPtr](#setwindowlongptr).

## <a name="cwindowsetwindowlongptr"></a><a name="setwindowlongptr"></a>CWindow::SetWindowLongPtr

Ändert ein Attribut des angegebenen Fensters und legt außerdem einen Wert für den angegebenen Versatz im zusätzlichen Fensterspeicher fest.
...
Siehe [SetWindowLongPtr](/windows/win32/api/winuser/nf-winuser-setwindowlongptrw) im Windows SDK.

Diese Funktion ersetzt die `CWindow::SetWindowLong` Methode. Um Code zu schreiben, der sowohl mit 32-Bit- als `CWindow::SetWindowLongPtr`auch mit 64-Bit-Versionen von Windows kompatibel ist, verwenden Sie .
...
Siehe [SetWindowPlacement](/windows/win32/api/winuser/nf-winuser-setwindowplacement) im Windows SDK.

## <a name="cwindowsetwindowpos"></a><a name="setwindowpos"></a>CWindow::SetWindowPos

Legt größe, Position und Z-Reihenfolge fest.
...
Siehe [SetWindowPos](/windows/win32/api/winuser/nf-winuser-setwindowpos) im Windows SDK.

Die zweite Version dieser Methode verwendet eine [RECT-Struktur,](/previous-versions/dd162897\(v=vs.85\)) um die neue Position, Breite und Höhe des Fensters festzulegen.
...
Siehe [SetWindowRgn](/windows/win32/api/winuser/nf-winuser-setwindowrgn) im Windows SDK.
...
Siehe [SetWindowText](/windows/win32/api/winuser/nf-winuser-setwindowtextw) im Windows SDK.
...
Weitere Informationen finden Sie unter [ShowCaret](/windows/win32/api/winuser/nf-winuser-showcaret) im Windows SDK.
...
Zeigt die Popupfenster des Fensters an oder blendet sie aus.
...
Weitere Informationen finden Sie unter [ShowOwnedPopups](/windows/win32/api/winuser/nf-winuser-showownedpopups) im Windows SDK.
...
Siehe [ShowScrollBar](/windows/win32/api/winuser/nf-winuser-showscrollbar) im Windows SDK.
...
Siehe [ShowWindow](/windows/win32/api/winuser/nf-winuser-showwindow) im Windows SDK.
...
Siehe [ShowWindowAsync](/windows/win32/api/winuser/nf-winuser-showwindowasync) im Windows SDK.
...
Siehe [UpdateWindow](/windows/win32/api/winuser/nf-winuser-updatewindow) im Windows SDK.
...
Weitere Informationen finden Sie unter [ValidateRect](/windows/win32/api/winuser/nf-winuser-validaterect) im Windows SDK.
...
Weitere Informationen finden Sie unter [WinHelp](/windows/win32/api/winuser/nf-winuser-winhelpw) im Windows SDK.
