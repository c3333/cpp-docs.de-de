...
|[Windows-Runtime App-Beispiele](/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Enthält herunterladbare Codebeispiele und Demo-Apps für Windows-Runtime.|
